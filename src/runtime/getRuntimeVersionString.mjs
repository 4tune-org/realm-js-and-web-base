...
async function loadPackageJSONs(project_root) {
	...
	const realm_package_json = require1.resolve("@4tune-poc/realm-js-and-web-base/package.json")

	const require2 = createRequire(realm_package_json)
	const runtime_package_json = require2.resolve("@4tune-poc/js-and-web-runtime/package.json")
